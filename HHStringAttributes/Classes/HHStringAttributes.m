...
- (void)setStrikethroughLine:(CGFloat)strikethroughLine
{
    _strikethroughLine = strikethroughLine;
    _attributes[NSStrikethroughStyleAttributeName] = @(strikethroughLine);
}
